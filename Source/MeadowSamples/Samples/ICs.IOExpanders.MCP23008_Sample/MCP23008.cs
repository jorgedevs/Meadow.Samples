...
namespace Meadow.Foundation.ICs.IOExpanders
{
    ...
    /// </summary>
    public class MCP23008 : IIODevice
    {
        /// <summary>
        ///     Raised on Interrupt
        /// </summary>
        ...
        */
        ...
        {
            Console.WriteLine("MCP23008 initialized()");
            ...
            Console.WriteLine("End - MCP23008 initialized()");
        }
        ...
        {
            Console.WriteLine($"MCP23008 CreateOutputPort({pin}, {initialState});");
        ...
        public ISpiBus CreateSpiBus(IPin[] pins, ushort speed = 1000)
        {
            throw new NotImplementedException();
        }

        public ISpiBus CreateSpiBus(IPin clock, IPin mosi, IPin miso, ushort speed = 1000)
        {
            throw new NotImplementedException();
        }
